# Script PowerShell pour créer la stack CloudFormation
...
$confirmation = Read-Host "Confirmez-vous la creation ? (oui/non)"
if ($confirmation -ne "oui") {
    Write-Host "Creation annulee" -ForegroundColor Red
    exit
}
