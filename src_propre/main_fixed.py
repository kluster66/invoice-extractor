...
Version corrigée pour Lambda (pas d'imports relatifs)
"""
...
# Import des modules locaux (version corrigée pour Lambda)
try:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python main_fixed.py <chemin_vers_pdf>")
        sys.exit(1)
