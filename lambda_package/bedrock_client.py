...
class BedrockClient:
    ...
    def __init__(self, region: str = None, model_id: str = None):
        ...
        self.model_id = model_id or config.Config.BEDROCK_MODEL_ID
        self.max_tokens = config.Config.BEDROCK_MAX_TOKENS
        self.temperature = config.Config.BEDROCK_TEMPERATURE
